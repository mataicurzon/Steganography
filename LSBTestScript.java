...
public class LSBTestScript {

    //This goes through and runs tests on all combinations of color channel LSBs and prints
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (File image : images) {
            if (image.getName().contains(".png")){
                ...
                bits = Helpers.pullSpecifiedBitsOfSpecificColors(orig, new int[] { 2, 1, 0 }, new int[] { 1 });
                bytes = Helpers.convertBitsToBytes(bits);
                Helpers.checkForHeader(bytes);
                System.out.println(Creation.convertBytesToStringOriginal(bytes, 500));
                System.out.println();
                ...
                bits = Helpers.pullSpecifiedBitsOfSpecificColors(orig, new int[] { 0 }, new int[] { 1 });
                bytes = Helpers.convertBitsToBytes(bits);
                Helpers.checkForHeader(bytes);
                System.out.println(Creation.convertBytesToStringOriginal(bytes, 500));
                System.out.println();
                ...
                bits = Helpers.pullSpecifiedBitsOfSpecificColors(orig, new int[] { 1 }, new int[] { 1 });
                bytes = Helpers.convertBitsToBytes(bits);
                Helpers.checkForHeader(bytes);
                System.out.println(Creation.convertBytesToStringOriginal(bytes, 500));
                System.out.println();
                ...
                bits = Helpers.pullSpecifiedBitsOfSpecificColors(orig, new int[] { 2 }, new int[] { 1 });
                bytes = Helpers.convertBitsToBytes(bits);
                Helpers.checkForHeader(bytes);
                System.out.println(Creation.convertBytesToStringOriginal(bytes, 500));
                System.out.println();
                ...
                System.out.println("Check Blue LSB's");
                bits = Helpers.pullSpecifiedBitsOfSpecificColorsVertical(orig, new int[] { 2 }, new int[] { 1 });
                for (int i = 0; i < 1001; i++) {
                    if (!bits.isEmpty())
                        bits.removeFirst();
                }
                ...
                bits = Helpers.pullSpecifiedBitsOfSpecificColorsVertical(orig, new int[] { 0, 1, 2 }, new int[] { 1 });
                bytes = Helpers.convertBitsToBytes(bits);
                Helpers.checkForHeader(bytes);
                System.out.println(Creation.convertBytesToStringOriginal(bytes, 500));
                System.out.println();
                ...
                bits = Helpers.pullSpecifiedBitsOfSpecificColorsVertical(orig, new int[] { 2, 1, 0 }, new int[] { 1 });
                bytes = Helpers.convertBitsToBytes(bits);
                Helpers.checkForHeader(bytes);
                System.out.println(Creation.convertBytesToStringOriginal(bytes, 500));
                System.out.println();
                ...
                bits = Helpers.pullSpecifiedBitsOfSpecificColorsVertical(orig, new int[] { 0 }, new int[] { 1 });
                bytes = Helpers.convertBitsToBytes(bits);
                Helpers.checkForHeader(bytes);
                System.out.println(Creation.convertBytesToStringOriginal(bytes, 500));
                System.out.println();
                ...
                bits = Helpers.pullSpecifiedBitsOfSpecificColorsVertical(orig, new int[] { 1 }, new int[] { 1 });
                bytes = Helpers.convertBitsToBytes(bits);
                Helpers.checkForHeader(bytes);
                System.out.println(Creation.convertBytesToStringOriginal(bytes, 500));
                System.out.println();
